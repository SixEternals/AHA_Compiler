...
private:
    std::list<GlobalVariable *>
        globals_list_; //& The Global Variables in the module
    std::list<Function *> functions_list_; //& The Functions in the module
    std::map<std::string, Value *>
        value_symbol_table_;               //& Symbol table for values
    std::map<Instruction::OpID, std::string> const
