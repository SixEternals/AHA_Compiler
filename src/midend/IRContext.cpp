...
Type *IRContext::getVoidType() {
    return void_ty_;
}

Type *IRContext::getLabelType() {
    return label_ty_;
}

IntegerType *IRContext::getInt1Type() {
    return int1_ty_;
}

IntegerType *IRContext::getInt32Type() {
    return int32_ty_;
}
...
PointerType *IRContext::getInt32PtrType() {
...
ArrayType *IRContext::getArrayType(Type *contained, size_t num_elements) {
